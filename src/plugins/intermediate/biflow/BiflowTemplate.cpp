...
BiflowTemplate::BiflowTemplate(const fds_template *tmplt, const fds_template *reversed_tmplt,
                               const fds_template *biflow_tmplt)
        : tmplt(tmplt), reversed_tmplt(reversed_tmplt), biflow_tmplt(biflow_tmplt) {}

uint16_t
BiflowTemplate::get_tmplt_id() const {
...
bool
BiflowTemplate::is_equal(uint16_t tmplt_id, uint16_t reversed_tmplt_id) const {
