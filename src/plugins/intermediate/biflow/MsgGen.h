...
public:
    ...
    void
    append_string(const std::uint8_t *value, uint16_t str_len);
    /**
    ...
    void
    append_ip(uint8_t * ip, enum fds_iemgr_element_type type);
    ...
    void
    append_field(struct fds_drec_field& field);
};
