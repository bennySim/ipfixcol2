...
Generator::Generator(uint16_t id, uint16_t scope_cnt)
{
...
Generator::Generator() : Generator(256) {}

Generator& Generator::operator=(Generator &&obj)
{
    if (this != &obj) {
...
void
Generator::append(uint16_t ie_id, uint16_t len, uint32_t ie_en)
{
    field_cnt++;
    size_t size_req = 4U;
    if (ie_en != 0) {
